...
function displayMarkers(places) {
	...
	for(var i=0; i<places.length; i++) {
		...
		(function (marker, title0, code, place) {
			kakao.maps.event.addListener(marker, "click", function () {
				displayInfowindow(marker, title0, place);
				console.log(title0 + " " + code);
			});
		    ...
		    itemEl.onmouseover = function () {
		    	displayInfowindow(marker, title0);
		    };
...
function addMarker(position, idx, title0) {
...
//인포윈도우에 장소명을 표시합니다
function displayInfowindow(marker, title0, place) {
	console.log(title0);
	var content = `
